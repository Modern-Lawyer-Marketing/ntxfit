  ...
  <div className="events-about">
    <div className="section">
      ...
      <div>
        ...
        <p>North Texas Families in Transition provides training for professionals to encourage more trained professionals to assist families involved in litigation.</p>
      </div>
